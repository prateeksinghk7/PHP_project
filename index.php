    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">"Welcome to the registration process for renting a room."</div>
          <div class="intro-heading text-uppercase">"It's a pleasure to have you here."<br></div>
        </div>
      </div>
    </header>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <?php
              ...
              if(count($data) !== 0){
                echo "<h2 class='text-center'>List of House Details</h2>";
              }
            ?>        
            <?php 
